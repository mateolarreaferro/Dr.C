...
<CsInstruments>
; sterevrb.orc (in the global subdirectory on the CD-ROM)

; instr 96 - general wavetable wind instrument going to stereo panning
; instr 196 - global stereo panning going to stereo reverb
...
apanl     linseg  ileft1, ipan1, ileft2, ipan2, ileft3      ; amplitude envelope for left channel
apanr     linseg  iright1, ipan1, iright2, ipan2, iright3   ; amplitude envelope for right channel
apanl     =       sqrt(apanl)
apanr     =       sqrt(apanr)
...
<CsScore>
; sterevrb.sco (in the global subdirectory on the CD-ROM)
; example shows bass clarinet with stereo panning and reverb by instruments 196 and 197
...
i96   16.000   3   10000    69.76   1.000   0.130   0.100   5   6   ; single note stereo panning

;stereo panning--------------------------------------------------------------------
;p1    p2    p3   p4   p5   p6   p7
;      start dur  pan1 pan2 pan3 dur1
i196    1    15   1    0    1    .5      ; stereo panning for first group of notes
i196   16     3   0    1    0    .5      ; stereo panning for last note

;stereo reverb---------------------------------------------------------------------
;p1    p2    p3   p4      p5      p6
;      start dur  revtime %reverb gain
i197   1.0   19   1.5     .15     1.0
end
</CsScore>
</CsoundSynthesizer>
<bsbPanel>
