...
<CsInstruments>
; reorder.orc  (in the global subdirectory on the CD-ROM)
; (similar to multpro1.orc, but with ring modulation after comb filter 2)

; instr 80 - general wavetable wind instrument (going to filter)
; instr 181 - global lowpass, highpass, bandpass and notch filters (going to comb2)
; instr 183 - global comb filter 2 (going to ring modulator)
; instr 197 - global ring modulator (going to spatialization) [renumbered from i180]
...
gacomb2   =       0
          endin
;______________________________________________________________________________________________________
instr 197                                                   ; global ring modulator
; parameters
...
<CsScore>
; reorder.sco  (in the global subdirectory on the CD-ROM)
; (similar to multpro1.sco, but with ring modulation after comb filter 2)
...
i197    1.5   24.6   1     200   .2   .7    .5    1     .5    .5    1     .01
