...
<CsScore>
; section.sco - use with wind.orc (in the season subdirectory on the CD-ROM)
; from R. Strauss - Til Eulenspiegel's Merry Pranks, opening horn solo
...
t 0 324       ; tempo statement for section 1

;p1   p2      p3      p4     p5        p6      p7      p8      p9  p10
;     start   dur     amp    Hertz     vibr    att     dec     br  inst
;bar 1-------------------------------------------------------------------
i15   2.000   0.700   6500   261.600   0.500   0.040   0.040   9   16    ; section 1
i15   3.000   0.700   7500   348.800   0.500   0.040   0.040   9   16
i15   4.000   0.700   8000   392.400   0.500   0.040   0.040   9   16
i15   5.000   3.000   6500   418.560   0.500   0.040   0.040   9   16    ; total note dur = 8 beats

;reverb------------------------------------------------------------------
;p1   p2      p3     p4      p5        p6
;     start   dur    revtime %reverb   gain
i194  2.0     6      1.2     .1        1.0     ; reverb adds 1.3 seconds to section duration

s

t 0 324       ; tempo statement for section 2

;bar 2-------------------------------------------------------------------
i15   1.000   0.700   6500   436.000   0.500   0.040   0.040   9   16    ; section 2
i15   2.000   0.700   7500   261.600   0.500   0.040   0.040   9   16
i15   3.000   0.700   8000   348.800   0.500   0.040   0.040   9   16
i15   4.000   0.700   6500   392.400   0.500   0.040   0.040   9   16
i15   5.000   3.100   7500   418.560   0.500   0.040   0.040   9   16
;bar 3-------------------------------------------------------------------
i15   8.000   0.700   7500   436.000   0.500   0.040   0.040   9   16

;reverb------------------------------------------------------------------
;p1   p2      p3     p4      p5        p6
;     start   dur    revtime %reverb   gain
i194  1.0     7.7    1.2     .1        1.0
