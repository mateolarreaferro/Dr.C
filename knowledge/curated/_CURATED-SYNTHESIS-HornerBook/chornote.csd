...
<CsInstruments>
; chornote.orc (in the noteffct subdirectory on the CD-ROM)

;instr 151 - general wavetable wind instrument with chorus
...
instr 151                                                   ; general wind instrument with chorus
; parameters
...
; p11 maximum delay time   20-40ms
;         20ms max delay keeps tight sound
;         30-40ms max delay gives more broadening
; p12 number of voices in chorus (2=doubling; 5 maximum)
...
;___________________________________________________________; chorus
achorus   =       asig                                      ; set achorus to original signal
...
;___________________________________________________________; output
chorend:
...
<CsScore>
; chornote.sco (in the noteffct subdirectory on the CD-ROM)
; note-specific chorus example (with flute)
...
;      start   dur   amp    Hertz     vibr    att     dec     br  inst  delay  voices
i151    1.000    5   4000   558.080   1.000   0.230   0.100   5   2     .05    5   
i151    5.000   10   5000   279.040   1.000   0.230   0.100   5   2     .01    4
i151    7.000    5   5000   837.120   1.000   0.230   0.100   5   2     .045   1
i151    9.000    6   5000   697.600   1.000   0.230   0.100   5   2     .025   3
i151   13.100    3   5000   976.640   1.000   0.130   0.100   5   2     .03    1

;reverb-------------------------------------------------------------------------------
;p1    p2      p3   p4        p5        p6
;      start   dur  revtime   %reverb   gain
i194   0.5     18   1.5       .05       1.0      ;  reverb blurs the chorus effect
end
</CsScore>
</CsoundSynthesizer>
