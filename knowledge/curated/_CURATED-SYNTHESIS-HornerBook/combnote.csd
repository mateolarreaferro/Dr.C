...
<CsInstruments>
; combnote.orc (in the noteffct subdirectory on the CD-ROM)

; instr 158 - general wavetable wind instrument with comb filtering
...
instr 158                                                   ; general wind instrument with comb filtering
; parameters
...
;___________________________________________________________; comb filter 1
ainput    =       asig                                      ; set ainput to original signal
acomb     comb    ainput,iring,iloop                        ; args:  sig, ring time, loop time
...
<CsScore>
; combnote.sco (in the noteffct subdirectory on the CD-ROM)
; note-specific comb filtering example (with contrabassoon)
...
;    start  dur amp  Hertz  vibr  att   dec  br in attn cmbFr  ring %comb
i158  1.000  5  3000 139.52 1.000 0.230 0.100 5 8  .20  139.52 .3   .25 
i158  5.000 10  5000  69.76 1.000 0.230 0.100 5 8  .25  139.52 .3   .25
i158  7.000  5  5000 104.14 1.000 0.230 0.100 5 8  .25  312.42 .3   .25
i158  9.000  6  5000  87.20 1.000 0.230 0.100 5 8  .35  384.80 .3   .25
i158 13.100  6  3000 122.08 1.000 0.130 0.100 5 8  .20  610.40 .3   .25
