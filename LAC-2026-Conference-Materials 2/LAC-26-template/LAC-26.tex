...
\def\papertitle{Templates for LAC-26, Maynooth, Ireland}
...
\begin{abstract}
This is the template file for the proceedings of the 20$^{\text{th}}$ 
Linux Audio Conference (LAC-26).
...
\bibliography{LAC-26} % requires file ifc-18.bib
