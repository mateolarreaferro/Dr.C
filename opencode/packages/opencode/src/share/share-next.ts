...
import type * as SDK from "@drc/sdk/v2"
...
export namespace ShareNext {
  ...
  const disabled = (process.env["DRC_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "true" || (process.env["DRC_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "1"
