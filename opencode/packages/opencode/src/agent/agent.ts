...
import PROMPT_SKETCH from "../session/prompt/sketch.txt"
...
export namespace Agent {
  ...
  const state = Instance.state(async () => {
    ...
    const result: Record<string, Info> = {
      csound: {
        ...
        permission: PermissionNext.merge(
          ...
          PermissionNext.fromConfig({
            ...
            ableton_send_clip: "allow",
            ableton_set_param: "allow",
            ableton_create_track: "allow",
            sketch_mood_palette: "allow",
            sketch_branch_compare: "allow",
            sketch_surprise: "allow",
            sketch_reference: "allow",
            technique_lineage: "allow",
            csd_walkthrough: "allow",
            csound_challenge: "allow",
            live_coding_start_stop: "allow",
            live_coding_set_channel: "allow",
            live_coding_hot_reload: "allow",
            edit_by_ear: "allow",
            suggest_params: "allow",
            auto_variation: "allow",
            gesture_to_envelope: "allow",
            export_ableton_clip: "allow",
            export_stems: "allow",
            export_preset_pack: "allow",
            export_cabbage_compile: "allow",
            memory: "allow",
          }),
          user,
        ),
      ...
      sketch: {
        name: "sketch",
        description: "Sketch pad mode for rapid sonic exploration. Generates many short sketches for comparison, responds to mood/texture descriptions, and pushes creative boundaries with surprise suggestions.",
        prompt: PROMPT_SKETCH,
        model: { providerID: "anthropic", modelID: "claude-sonnet-4-5" },
        temperature: 0.8,
        options: { designMode: true, sketchMode: true },
        permission: PermissionNext.merge(
          defaults,
          PermissionNext.fromConfig({
            question: "allow",
