...
beforeAll(async () => {
  ...
  mock.module("@drc/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@drc/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@drc/ui/icon", () => ({ Icon: () => null }))
  mock.module("@drc/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
